...
module.exports = class extends Command {
	...
	constructor(...args) {
		super(...args, {
			runIn: ["text"],
			description: "Get information on a role with an id or a mention or name. Remember to match the case of the role.",
			usage: "<Role:role>",
			aliases: ["roleinfo"],
	...
	async run(message, [role]) {
		...
		const roleInfo = new MessageEmbed()
			...
			.addField("❯ Permissions", allPermissions ? allPermissions : "No permissions");

		return message.sendEmbed(roleInfo);
	}
