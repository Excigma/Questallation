const { config: mathConfig } = require("mathjs"),
	{ Event, version: klasaVersion, Duration } = require("klasa");
...
module.exports = class extends Event {
	...
	async run() {
		...
		console.log(`| |__  __  _____ _  __ _ _ __ ___   __ _| |_) | ___ | |_  | Ping:   ${Math.round(this.client.ping)}`);
