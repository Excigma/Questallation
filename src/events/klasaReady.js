...
module.exports = class extends Event {
    ...
    async run() {
        ...
        console.log(`| |__  __  _____ _  __ _ _ __ ___   __ _| |_) | ___ | |_  | Ping:   ${Math.round(this.client.ws.ping)}ms`);
        ...
        if (!this.client.schedule.tasks.some(task => task.taskName === "@hourly")) this.client.schedule.create("getEmojis", "@hourly", { catchUp: true });
    }
};
